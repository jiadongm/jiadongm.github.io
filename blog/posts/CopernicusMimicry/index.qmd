...
In the textbook geocentric picture we are used to seeing, Earth is still at the centre, with every planet going evenly round it in a single circle. This simplistic version of geocentrism does not explain the retrograde motion. Ptolemaic astronomy was actually much more sophisticated mathematically. In a typical construction, a planet travelled on a small circle, an **epicycle**, while the centre of that small circle travelled on a larger circle, the **deferent**, positioned around Earth. If the two rotations are chosen appropriately, the planet traces a loop in the sky during part of its journey: retrograde motion is reproduced by geometry.[^3]
...
A nice example comes from Copernicus himself. He owned a copy of the *Alfonsine Tables*, a set of astronomical tables calculated in the Ptolemaic tradition. During an unusual gathering of Mars, Jupiter and Saturn in 1503–1504, Copernicus wrote in his copy that Mars was more than two degrees ahead of the tabular prediction, while Saturn lagged by one and a half degrees. Owen Gingerich's modern reconstruction of the same episode found that Jupiter had been predicted rather accurately. Moreover, a two-degree error is about four times the apparent width of the full Moon: visually detectable and inadequate for later high-precision astronomy, but still good enough to locate the planet in the correct patch of sky. More importantly, Gingerich points out that these errors as *correctable* by changing the parameters of a Ptolemaic system (and Copernicus would know that); they were not, by themselves, a reason to dismantle geocentrism.[^6]
...
Of course, this does not mean that Ptolemy was right. It means that the evidence for a true framework can initially arrive burdened with unresolved problems. Heliocentrism took a long time to become securely established: Copernicus would still need the later support of Kepler's ellipses, telescopic observations and Newtonian mechanics.[^11]
...
His Sun-centred paradigm offered just this sort of correction: planetary distances, periods and retrogressions became parts of one schema. Copernicus was not eliminating metaphysics from astronomy; he was replacing one physical and philosophical picture of celestial order with another.[^13]
...
There were good rational reasons for a sixteenth-century astronomer to remain loyal to geocentrism and Ptolemaic machinery. Copernicus was asking them to abandon an established predictive practice for a still incomplete alternative: an Earth whose motion violated the available Aristotelian physics, a Sun-centred system that still retained circular motion and epicycles and a theory lacking the later support of telescopic observations, Kepler's ellipses and Newton's mechanics. It is true that a sixteenth-century astronomer might become increasingly dissatisfied with increasingly complex Ptolemaic models; there could be epicycles upon epicycles, for example. But this was not a problem that heliocentrism could immediately solve.

Punnett's objection to gradual mimicry had a similar momentum. Once we see a convincing mimetic butterfly, it is easy to say that natural selection must have built the resemblance little by little. But Punnett insisted that the first little step was exactly what needed explanation. The sharply separated female forms of *Papilio polytes* made the objection more pointed: to Punnett, they suggested a new mimetic type arriving in a discontinuous jump, not a spectrum of useful intermediates.
